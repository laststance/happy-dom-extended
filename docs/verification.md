...
| ------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Node source regressions               | 236 tests, including the Vitest entry loader, the Web Storage override, the thread-pool global setup, the skia-canvas install guidance and finalizer failures                                            |
