...
- `pnpm check:docs`: every relative Markdown link and heading anchor in the tracked documentation resolves. Headings must be plain Markdown, because the check cannot reproduce GitHub's anchor for a heading containing raw HTML.
